    ...
    <div  >
      ...
      <div className="main">
        <div className="topbar">
          ...
          <Link to='/' ><button onClick={handleLogout} style={{background:'rgba(113, 99, 186, 255)', width:'80px',height:'40px',borderRadius:'10px',position:'relative', left:'-270px' ,textAlign:'center',top:'-2px', fontSize:'20px' ,color:'black',border:'none' }}>Logout</button></Link>
        </div>
        ...
        <div className="details">
          <div className="recentOrders">
            <div className="cardHeader">
              <h2 style={{fontSize:'23px'}}>Todays Students</h2>
              <Link to="/admin/student" className="btn" style={{position:'relative',left:'30%',width:'10%',fontSize:'18px'}}>
                View All
              </Link>
            </div>
